...
/**
 * @file
 * Enables modules and site configuration for an AVC site installation.
 */
 ...
 */
function avc_install_tasks(&$install_state) {
  $tasks = [];
  ...
  if (\Drupal::state()->get('social_install_demo_content', 0) === 1) {
    $tasks['avc_install_demo_content'] = [
 ...
 * there.
 */
function avc_install_tasks_alter(&$tasks, $install_state) {
  // Override the core install_verify_requirements task function.
  $tasks['install_verify_requirements']['function'] = 'avc_verify_custom_requirements';
 ...
 */
function avc_verify_custom_requirements(array &$install_state) {
 ...
 *   Batch settings.
 */
function avc_install_demo_content(array &$install_state) {
  ...
  $batch['operations'][] = [
    '_avc_uninstall_module_batch',
    [['social_demo'], 'social_demo'],
  ];

  $batch['operations'][] = [
    '_avc_index_demo_content',
    [],
  ];
 ...
 */
function _avc_install_module_batch($module, $module_name, &$context) {
  set_time_limit(0);
 ...
 */
function _avc_uninstall_module_batch($module, $module_name, &$context) {
  set_time_limit(0);
 ...
 */
function _avc_add_demo_batch($demo_type, $demo_description, &$context) {
  set_time_limit(0);
 ...
 */
function _avc_index_demo_content(&$context) {
